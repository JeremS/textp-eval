(ns fr.jeremyschoffen.textp.alpha.eval.build
  (:require
    ...
    [fr.jeremyschoffen.textp.alpha.eval.docs.core :as docs]
    [build :refer [token]]))
...
(def conf (mbt-defaults/config
            {::project/name "textp-eval"
             ::project/author "Jeremy Schoffen"
             ::project/git-url "https://github.com/JeremS/textp-eval"
